...
public class EditProfileActivity extends Activity {
	...
	private void loadProfileData() {
		...
		// preference object
			...
			// Load the profile phone
			mKey = getString(R.string.preference_key_edit_profile_activity_profile_phone);
			mValue = mPrefs.getString(mKey, "");
			((EditText) findViewById(R.id.editProfilePhone)).setText(mValue);
	...
	private void saveProfileData() {
		...
		// Save profile phone information
		mKey = getString(R.string.preference_key_edit_profile_activity_profile_phone);
		mValue = (String) ((EditText) findViewById(R.id.editProfilePhone))
				.getText().toString();
		mEditor.putString(mKey, mValue);
